...
if(isset($_SESSION['location']) && $_SESSION['location'] == "manager")
{
?>
        ...
        <div class="col-md-12 col-sm-12">
            <div class="container">
                <div class="page-header">
                    <h2>Engineer <small>Name of the admin</small></h2></div>
            </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-md-3 col-sm-3 collapse navbar-collapse " id="toogleme-1" role="tablist">
            <ul class="list-group shadow-left">
                ...
                <li class="active"><a href="#devices" role="tab" data-toggle="tab" class="list-group-item"><span class="glyphicon glyphicon-phone"></span> Devices </a></li>
        ...
        <div class="col-md-10 col-sm-9 tab-content shadow-left">
            ...
            <div class="row tab-pane fade in active" id="devices">
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table">
                            <thead>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><form action="assets/deleteinfo/delete_device.php" method="post">
                                        <input type="submit" value="Delete" name="device">
                                        <input type="hidden" name="device_id" value="<?php echo $row1->location_id; ?>">
                                    </form></td>
